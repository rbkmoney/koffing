...
export class CreateWebhookService {
    ...
    private eventTypes: EventTypePresent[] = [
        ...
        new EventTypePresent('PaymentRefundCreated', 'возврат платежа успешно создан', 'InvoicesTopic'),
        new EventTypePresent('PaymentRefundSucceeded', 'возврат платежа прошел успешно', 'InvoicesTopic'),
        new EventTypePresent('PaymentRefundFailed', 'возврат платежа завершился неудачей', 'InvoicesTopic'),
